...
- Заголовок = главное обещание ролика, собирается **по словам в такт речи** (каждое слово входит
  на своём таймкоде из распознавания).
- **Логотип бренда, о котором ролик, — в первые 1–2 секунды** (владелец: «чтобы сразу
  ассоциировали с Claude»); логотип влетает на слове с названием бренда.
